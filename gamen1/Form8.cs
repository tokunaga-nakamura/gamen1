...
namespace gamen1
{
    public partial class Form8 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            dt.Columns.Add("部品名");
            dt.Columns.Add("移動元在庫区分");
            dt.Columns.Add("移動元取引先コード");
            dt.Columns.Add("移動元受注No1");
            dt.Columns.Add("移動元受注No2");
            dt.Columns.Add("移動先在庫区分");
            dt.Columns.Add("移動先取引先コード");
            dt.Columns.Add("移動先受注No1");
            dt.Columns.Add("移動先受注No2");
            dt.Columns.Add("数量");
